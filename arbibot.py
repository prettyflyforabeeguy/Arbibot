...
class ArbiBot():
    def __init__(self):
        ...
        self.tradepairs = _appsettings.AppSettings().appsetting_vsearch(self.appsettings_dict, "TradePairs")
    ...
    def get_cpatex_info(self, coin, timestamp):
        ...
        for each_pair in self.tradepairs:
            ...
            try:
                ...
                c = each_pair[clenght:]
                c = c.upper()
                price = _api.APIClient().cmc_Price_Quote(str(c), "USD")
        ...
        while True:
            try:
                ...
                if self.cpatexEnabled == True:
                    self.get_cpatex_info(self.coin, dt)
                    print("")
                
                if self.crex24Enabled == True:
                    self.get_crex24_info(self.coin, dt)
                    print("")

                if self.xeggexEnabled == True:
                    self.get_xeggex_info(self.coin, dt)
                    print("")
